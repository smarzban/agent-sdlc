...
- Report back **only the prior findings that still hold** — re-state each one, keeping its original
  severity and location (adjust the line number if the code moved).
