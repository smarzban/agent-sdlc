...
| --- | --- | --- | --- | --- |
| AC-1 | Build remediation protocol | Agent SDLC skill text plus Git CLI and Python 3 | T-1, T-3, T-4, T-5, T-6, T-7 | traced |
...
| AC-5 | Build remediation protocol | Agent SDLC skill text plus Git CLI and Python 3 | T-1, T-3, T-4, T-5, T-6, T-7 | traced |
| AC-6 | Build remediation protocol | Agent SDLC skill text plus Git CLI and Python 3 | T-1, T-5 | traced |
| AC-7 | Build remediation protocol | Agent SDLC skill text plus Git CLI and Python 3 | T-1, T-3, T-4, T-5, T-6, T-7 | traced |
...
None. T-6 and T-7 are bounded tasks that carries the complete snapshot command isolation boundary and its tests.
